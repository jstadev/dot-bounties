...
const connectPolkadot = require('./src/polkadot');
const fetchHistoricalData = require('./src/fetchHistoricalData');
      ...
      if (event.section === 'bounties') {
        ...
        if (event.method === 'ChildBountyCreated') {
          ...
          try {
            ...
            console.error('Error creating child bounty:', error);
          }
        }

        // Handle additional bounty-related events as needed
      }
    });
  }).catch((error) => {
